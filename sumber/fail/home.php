		...
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "book.php"><i class = "glyphicon glyphicon-book"></i>Equipment Item</a></li>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<img src = "images/logo.jpg" height = "400px" width = "100%" />
			</div>
		</div>
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">Borrowing Item Equipment System &copy; All rights reserved 2016</label>
			</div>
		</nav>
	</body>
<!--
